<template>
    <div class="project-list-index">
        ...
        <a-modal
                destroyOnClose
                class="taskCreateLayout"
                :width="800"
                v-model="taskSendEmailModal.modalStatus"
                :title="taskSendEmailModal.modalTitle"
                :footer="null"
        >
            <task-create :code="currentProjectCode" @update="updateProject"></task-create>
        </a-modal>
...
<script>
    ...
    import taskCreate from '@/components/email/taskCreate'
        ...
        methods: {
            ...
            doAction(record, action, index) {
                ...
                if (action == 'new') {
                    ...
                    app.taskSendEmailModal.modalStatus = true;
                } else if (action == 'edit') {
